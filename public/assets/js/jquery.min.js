...
document.getElementById("adder").onclick =function () {
    ...
    document.getElementById("element").append('<input type="text" placeholder="Header" name="header" style="display: block; width: 100%; margin: auto;" required>')
        //$("#element").append('<div id="holder"><div style="padding: 15px"><input type="text" placeholder="Header" name="header" style="display: block; width: 100%; margin: auto;" required></div><div class="container" style="padding: 0; margin: 0; margin-bottom: 15px; min-width: 100%;"><div class="row"><div class="col-lg" style="padding: 15px ;margin: 0;"><textarea placeholder="Enter your comment here" rows="4" cols="50" style="margin-top: 15px;margin-bottom: 15px;margin-right: 0px;height: 350px;width: 100%;display: inline-block;"></textarea></div><div class="col-lg" style="padding: 15px ;margin: 0;"><div class="uploader" onclick="$('#filePhoto').click()" style="margin-top: 15px;margin-left: 0;margin-bottom: 15px;display: inline-block;position: relative;overflow: hidden;width: 100%;height: 350px;background: #f3f3f3;text-align: center;vertical-align: middle;line-height: 350px;">click here or drag image for preview<img src="/pictures/Empty.png" /><input type="file" name="userprofile_picture" id="filePhoto" /></div></div></div></div></div>');
};